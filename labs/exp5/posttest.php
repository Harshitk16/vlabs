...
$a = array(
1 => array(
   0 => " Which of the following is the correct format for if statement?",
   1 => "If boolean expression<br>
then statement or compound statement<br>
elseif boolean expression<br>
then statement or compound statement<br>
else statement or compound statement<br>
end if",
   2 => "If boolean expression<br>
then statement or compound statement<br>
elsif boolean expression<br>
then statement or compound statement<br>
else statement or compound statement<br>
end if",
   3 => "If boolean expression<br>
then statement or compound statement<br>
elif boolean expression<br>
then statement or compound statement<br>
else statement or compound statement<br>
end if",
   4 => "If boolean expression<br>
then statement or compound statement<br>
else <br>
...
2 => array(
   0 => "Temporary stored procedures are stored in _________ database.",
   1 => "Master",
   2 => "Model",
   3 => "Tempbd",
   4 => "All of the above",
...
3 =>  array(
    0=> "Declare out of classroom seats condition
<br>
