...
2 => array(
   0 => "If we want to retain all duplicates, we must write ________ in place of union.",
   1 => "Union all",
   2 => "Union some",
   3 => "Intersect all",
   4 => "Intersect some",
...
(SELECT course id
FROM SECTION
WHERE semester = ’Spring’ AND YEAR= 2010);<br>This query displays",
    1 => "Only tuples from second part",
    2 => "Only tuples from the first part which has the tuples from second part",
    3 => "Tuples from both the parts",
