...
$a = array(
1 => array(
   0 => "Select ID, name, dept name, salary * 1.1 where instructor;
...
2 => array(
   0 => "Correlated subqueries are used for ",
   1 => "row by row processing",
   2 => "coloumn by row processing",
   3 => "coloumn by coloumn processing",
   4 => "row by coloumn processing",
   6 => 1
),
3 =>  array(
    0=> " A subquery that uses a correlation name from an outer query is called a",
    1 => "Derived subquery",
   2 => "Induced Subquery",
   3 => "Deduced subquery",
