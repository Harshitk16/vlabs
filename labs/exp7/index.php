            ...
            <!-- Content Header (Page header) -->
                ...
                <h1 align="center">
                   ...
                   <section class="theory">
                      <h3> <b>Aim</b> </h3>
                    <p >
                    <i >&#x27A3;</i> To give you the fundamental knowledge of the SQL Sub Queries and its types,Co-related Query and Nested Query with its operator <br>
                    <i>&#x27A3;</i>In this experiment we are going to have,a deep understanding of the usage of subQueries and operators of NEsted queries with example</p>
                    <p >1.Sub Queries<br>
	                     2. Co-related Sub Queries.<br>
	                     3. Nested queries<br>
