...
$a = array(
1 => array(
   0 => "All aggregate operations, return a value of null when applied on an",
   1 => "Avg collection",
   2 => "Sum collection",
   3 => "Data collection",
   4 => "Empty collection",
...
2 => array(
   0 => "How to write random function",
   1 => "SELECT RAND();",
   2 => "SELECT RAND()",
   3 => "RAND();",
   4 => "RAND()",
...
3 =>  array(
    0=> "How to write sum function",
    1 => "SELECT SUM(*) FROM Table_name;",
   2 => "SELECT SUM(*) FROM Table_name",
   3 => "SELECT SUM(*)",
   4 => "SELECT SUM(*) FROM column_name",
   6 => 1
),
);
