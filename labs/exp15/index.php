          ...
          <section class="content-header">
            ...
            <!-- Content Header (Page header) -->
                ...
                <h1 align="center">
                    ...
                    <div>
                    <i >&#x27A3;</i>To learn Triggers and there syntax in SQL<br>
                    <h3 style="margin-top:5%"> <b>Introduction</b> </h3>
                <!--    <p style="font-size:130%; margin-top:2%">-->
In this experement you will be get to know about the triggers in datails <b>what are the triggers</bb>what will be there syntax</b><br><br>
Make sure you fullfil the prerequisits before moving ahead.
<br><b>PREREQUISITS:</b><br>
1) Concept covered in last experiments .<br>
2) <b>Minimum 50 percentage</b> in the post-test.<br>
<br>
<h3><b>What is triggers?</b></h3>
                      A trigger is a SQL procedure that initiates an action when an event (INSERT, DELETE or UPDATE) occurs. A trigger cannot be called or executed, the DBMS automatically fires the trigger as a result of a data modification to the associated table. Triggers are used to maintain the referential integrity of data by changing the data in a systematic fashion.<br>
