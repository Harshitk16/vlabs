...
$a = array(
1 => array(
   0 => "Ranking of queries is done by which of the following?:",
   1 => "Group by",
   2 => "Order by",
   3 => "Having",
   4 => "Both Group by and Order by",
   6 => 2
),
2 => array(
   0 => "SELECT ID, GPA FROM student grades ORDER BY GPA ____________;<br>
...
3 =>  array(
    0=> "Which of the following is used to denote the selection operation in relational algebra?",
    1 => "Pi (Greek)",
   2 => "Sigma (Greek)",
   3 => "Lambda (Greek)",
   4 => "Omega (Greek)",
