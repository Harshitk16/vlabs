...
$a = array(
1 => array(
   0 => "The union operation is represented by",
   1 => "∩",
   2 => "U",
   3 => "–",
   4 => "*",
...
2 => array(
   0 => "The intersection operator is used to get the _____ tuples.",
   1 => "Different",
   2 => "Common",
   3 => "All",
   4 => "Repeating",
...
3 =>  array(
    0=> "Which of the following correctly describes the between predicate in the where clause?",
    1 => "It is used to check whether a value is in between two specified values",
   2 => "It is used to check whether a value is exactly in the center of the relation alphabetically",
   3 => "It is used to check whether a value is in between any two other values in the database",
