...
2 => array(
   0 => "Syntex To Grant all the permissions in the form of set of priviliges is :",
   1 => "GRANT ALL username;",
   2 => "GRANT sysdba TO username;",
   3 => "GRANT sysdba username;",
   4 => "None of the mentioned",
   6 => 2
),
3 =>  array(
    0=> "Syntex to GRANT the Store user table and its data in database",
    1 => "ALTER USER username QUOTA UNLIMITED ON SYSTEM;",
   2 => "GRANT USER username TABLE DATA;",
   3 => "ALTER USER username UNLIMITED SYSTEM;",
   4 => "NOne of the mentioned",
   6 => 1
),
4 =>  array(
    0=> "_______ operators that are used in LIKE clause.",
    1 => "Arithmetic",
   2 => "Logical",
   3 => "Both A and B",
   4 => "Wildcard",
...
5 =>  array(
    0=> "Syntex to REVOKE CREATE SESSION to username is :",
    1 => "REVOKE CREATE SESSION username;",
   2 => "REVOKE SESSION TO username;",
   3 => "REVOKE CREATE SESSION TO username;",
   4 => "None of the mentioned",
   6 => 3
),
);
