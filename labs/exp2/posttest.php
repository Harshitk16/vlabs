...
$a = array(
1 => array(
   0 => "CREATE TABLE employee (name VARCHAR, id INTEGER)<br>What type of statement is this?",
   1 => "DML(Data Manipulation Language)",
   2 => "DDL(Data Definition Language)",
   3 => "View",
   4 => "Intrigity constant",
   6 => 2
),
2 => array(
   0 => "INSERT INTO instructor VALUES (10211, ’Smith’, ’Biology’, 66000);<br>What type of statement is this?",
   1 => "Query",
...
3 =>  array(
    0=> "The basic data type char(n) is a _____ length character string and varchar(n) is _____ length character.",
    1 => "Fixed, equal",
   2 => "Equal, variable",
   3 => "Fixed, variable",
   4 => " Variable, equal",
