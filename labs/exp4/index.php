          ...
          <section class="content-header">
            ...
            <!-- Content Header (Page header) -->
                ...
                <h1 align="center">
                    ...
                    <div>
                    <i >&#x27A3;</i>To learn Operators and there syntax in SQL<br>
...
<br>
<h3><b>What is operators?</b></h3>
                      An operator is a symbol that represents an action or process these symbols were adapted from matematics and logic.
                      <br>An operator is capable of manupulating a certain value or operand.The operators are the backbone of any program and
                      <br>they are used for very simple function like counting to complex algorithms.
                    <br>
                    For Example: = (equals to operator),  + (addition operator), % (modulus operator), and many more.</p>
                </section>
