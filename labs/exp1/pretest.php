      ...
      <div class="content-wrapper">
        ...
        <section class="content">
          ...
          <p style="text-align:justify; font-size:130%">
					...
					Q-1: What is DBMS <br><br>
				 	Q-2:What is SQL?<br><br>
					Q-3: Who proposed the relational model?<br><br>
					Q-4:What do database languages do? <br><br>
					Q-5: Enlist the various relationships of database. <br><br>
				</ol>
			</p>
