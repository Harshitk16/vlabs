        ...
        <span class="sr-only">Toggle navigation</span>
          ...
          <section class="content-header">
            ...
            <!-- Content Header (Page header) -->
                ...
                <br>
                <h3><b>How to manupulate tables?</b></h3>
                                  After creating table. we can change the data insterd in the table and can also remove the data from the table before moving ahead we need to know about data manupulation lanungage(DML).
                </section>
